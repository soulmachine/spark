...
class DenseVectorSuite extends FunSuite {
  test("add") {
    ...
    val v3 = DenseVector(0.0, 0.0, 0.0)
    val v4 = DenseVector(-1.0, -2.0, -3.0)
    val v5 = RandomAccessSparseVector(3, (0, 3.0), (1, 4.0))

    assert(v1 + v2 == DenseVector(5.0, 7.0, 9.0))
    assert(v1 + v2 != DenseVector(5.0, 6.99, 9.0))
    assert(v1 + v3 == v1)
    assert(v1 + v4 == v3)

    assert(DenseVector(4.0, 6.0, 3.0) == RandomAccessSparseVector(3, (0, 4.0), (1, 6.0), (2, 3.0)))
    assert(v1 + v5 == DenseVector(4.0, 6.0, 3.0))
    assert(v1 + v5 == RandomAccessSparseVector(3, (0, 4.0), (1, 6.0), (2, 3.0)))
  }
  ...
  test("sub") {
    ...
    val v3 = DenseVector(0.0, 0.0, 0.0)
    val v4 = DenseVector(-1.0, -2.0, -3.0)
    val v5 = DenseVector(1.0, 2.0, 3.0)
    val v6 = RandomAccessSparseVector(3, (0, 3.0), (1, 4.0))
  ...
  test("dot") {
    ...
    val v2 = DenseVector(4.0, 5.0, 6.0)
    val v3 = DenseVector(0.0, 0.0, 0.0)
    val v4 = RandomAccessSparseVector(3, (0, 3.0), (1, 4.0))
  ...
  test("dimension") {
    assert(3 == DenseVector(1.0, 2.0,3.0).dimension)
  }
